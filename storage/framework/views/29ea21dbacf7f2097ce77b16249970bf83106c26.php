...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <?php $__empty_1 = true; $__currentLoopData = $lpj; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rew => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
          <?php if($row->status = 1 && CekLengkap::cek($row->id) == true): ?>
            <tr>
                <td><?php echo e($no++); ?></td>
                  <td>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sipresma\resources\views/pengajuanmasuk/lpjmasuk.blade.php ENDPATH**/ ?>