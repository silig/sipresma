...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Daftar Proposal yang harus upload LPJ</h1>
          </div>
          <div class="col-sm-6">
    ...
    <section class="content">
        ...
        <?php $__empty_1 = true; $__currentLoopData = $lpj; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rew => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
          <?php if($row->status = 1 && CekLengkap::cek($row->id) == false): ?>
            <tr>
                <td><?php echo e($no++); ?></td>
                  <td>
                  <?php if($row->jenis_proposal=='delegasi'): ?>
                      ...
                      <button type="button" class="dropdown-toggle" data-toggle="dropdown" style="background-color: #adb5bd">
                          ...
                          <div class="dropdown-menu" role="menu">
                            <a class="dropdown-item" href="<?php echo e(route('edit_proposal', $row->id)); ?>">Edit</a>
                            <a class="dropdown-item" href="<?php echo e(route('hapus_proposal', $row->id)); ?>">hapus</a>
                  ...
                  <?php if($row->jenis_proposal=='penyelenggara'): ?>
                      ...
                      <button type="button" class="dropdown-toggle" data-toggle="dropdown" style="background-color: #adb5bd">
                        ...
                        <div class="dropdown-menu" role="menu">
                            <a class="dropdown-item" href="<?php echo e(route('edit_proposal1', $row->id)); ?>">Edit</a>
                            <a class="dropdown-item" href="<?php echo e(route('hapus_proposal', $row->id)); ?>">hapus</a>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sipresma\resources\views/pengajuanmasuk/proposaldisetujui.blade.php ENDPATH**/ ?>