...
<div class="content-wrapper">
    ...
    <section class="content" style="margin-left: 15px;margin-right: 15px">
	    ...
	    <div class="card card-info">
	              ...
	              <!-- /.card-header -->
	              <!-- form start -->
	              <form role="form" class="form-horizontal" files="true" action="{{ route('update_proposal', $data->id) }}" method="post" enctype="multipart/form-data">
	                                @csrf
	                    <div class="card-body">
	                    ...
	                    <div class="form-group row">
                     	...
                     	<div class="form-group row">
	                        ...
	                        <div class="col-sm-8">
	                          <input type="number" name="jumlah_dana" class="form-control" value="{{ $data->ajuandana }}" readonly="">
	                        </div>
	                        <p class="text-danger">{{ $errors->first('jumlah_dana') }}</p>
	                      </div>
	                    	<div class="form-group row">
	                        <label  class="col-sm-4 control-label">Dana disetujui *</label>
	                        <div class="col-sm-8">
	                          <input type="number" name="danadisetujui" class="form-control" value="{{ $data->danadisetujui }}">
	                        </div>
	                        <p class="text-danger">{{ $errors->first('jumlah_dana') }}</p>
	                      </div>
	                     <div class="form-group row">
