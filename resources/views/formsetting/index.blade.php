        ...
        <div class="content-header">
            <div class="container-fluid" >
                <div class="row mb-2" style="margin-left: 20px">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">Setting Form</h1>
                    </div>
                    <div class="col-sm-6">
                    ...
                    <div class="col-md-8" style="margin-left: 200px">
                        <div class="card">
                          <div class="card-header" style="background-color:#31708f;border-color: #bce8f1;">
                              <p><h4 align="center" style="color: white">Hamalam ini untuk pengaturan wadek I dan KTU digunakan pada saat cetak pengesahan atau surat tugas</h4></p>
                          </div>
                          <!-- /.card-header -->
                          <div class="card-body">
                          @if (session('success'))
                                            ...
                                            <div class="modal-dialog modal-sm" style="border box-shadow : 0 4px 8px 0 rgba(0,0,0,0.2),0 6px 20px 0 rgba(0,0,0,0.19);">
                                              <div class="modal-content" style="width: 500px">
                                                <div class="modal-header" style="background-color: #007bff">
                                                  <h4 class="modal-title" style="color: #f8f9fa">Edit</h4>
                                                  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                    <span aria-hidden="true">×</span>
                                                  </button>
                                                </div>
                                                <div class="modal-body">
                                                  <form role="form" method="POST" action="{{ route('formsetting.update', $row->id) }}">
                                                  @csrf
                                                    ...
                                                    <div class="card-body">
                                                      ...
                                                      <div class="form-group">
                                                        ...
                                                        <select name="jabatan"  class="form-control">
                                                          ...
                                                          <option value="KTU" id="univ" {{ $row->jabatan == 'KTU' ? 'selected':'' }}>KTU</option>
                                                          <option value="Wadek I" id="lain" {{ $row->jabatan == 'Wadek I' ? 'selected':'' }}>Wadek I</option>
                                                    </select>
                                                      </div>
                                                    </div>
                                                    <!-- /.card-body --> 
