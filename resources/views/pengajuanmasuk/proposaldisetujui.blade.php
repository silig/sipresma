...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        @forelse ($lpj as $rew => $row)
          @if ($row->status = 1 && CekLengkap::cek($row->id) == false)
            <tr>
                <td>{{ $no++ }}</td>
                  <td>
                  @if ($row->jenis_proposal=='delegasi')
                      ...
                      <button type="button" class="dropdown-toggle" data-toggle="dropdown" style="background-color: #adb5bd">
                          ...
                          <div class="dropdown-menu" role="menu">
                            <a class="dropdown-item" href="{{ route('edit_proposal', $row->id) }}">Edit</a>
                            <a class="dropdown-item" href="{{ route('hapus_proposal', $row->id) }}">hapus</a>
                  ...
                  @if ($row->jenis_proposal=='penyelenggara')
                      ...
                      <button type="button" class="dropdown-toggle" data-toggle="dropdown" style="background-color: #adb5bd">
                        ...
                        <div class="dropdown-menu" role="menu">
                            <a class="dropdown-item" href="{{ route('edit_proposal1', $row->id) }}">Edit</a>
                            <a class="dropdown-item" href="{{ route('hapus_proposal', $row->id) }}">hapus</a>
