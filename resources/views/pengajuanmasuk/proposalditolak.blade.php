                                        ...
                                        <input type="hidden" name="_method" value="PUT">
                                          <div class="card-body">
                                            ...
                                            <div class="form-group">
                                              ...
                                              <input type="number" class="form-control" id="test" placeholder="" name="danadisetujui" value="" min="1" max="{{$row->ajuandana}}" required="">
                                              @endif
                                              ...
                                              <input type="number" class="form-control" id="test" placeholder="" name="danadisetujui" value="" min="1" max="{{ DanaSisa::sisa($row->jenis_proposal,$row->departemen,substr($row->created_at,0,4)) }}" required="">
                                              @endif
                                            </div>
                                          </div>
                                          <!-- /.card-body --> 
