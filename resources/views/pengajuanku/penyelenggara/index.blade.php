                ...
                <td >
                    <div class="btn-group">
                        ...
                        <div class="dropdown-menu" role="menu">
                          <a class="dropdown-item" href="{{ route('penyelenggara.detail', encrypt($row->id)) }}" target="_blank">Detail</a>
                          <a class="dropdown-item" href="{{ route('penyelenggara.edit', encrypt($row->id)) }}">Edit</a>
                          </div>
                      </div>
                </td>
...
<!-- proposal disetujui, LPJ belum -->
          @if ($row->status == 1 && $row->statuslpj == 0 && CekLengkap::penyelenggara($row->id) == false)
            <tr >
                <td>{{ $no++ }}</td>
                ...
                <td >
                    <div class="btn-group" >
                        ...
                        <div class="dropdown-menu" role="menu">
                          <a class="dropdown-item" href="{{ route('penyelenggara.detail', encrypt($row->id)) }}" target="_blank">Detail</a>
                          <a class="dropdown-item" href="{{ route('lpj.penyelenggara', encrypt($row->id)) }}">LPJ</a>
                          </div>
                      </div>
                </td>
...
<!-- Berkas lengkap -->
          @if ($row->status == 1 && $row->statuslpj == 0 && CekLengkap::penyelenggara($row->id) == true)
            <tr >
                <td>{{ $no++ }}</td>
...
<!--tidak terlaksana -->
          @if ($row->status == 1 && $row->statuslpj == 3)
            <tr >
                ...
                <td><a style="background-color: black;color: white">tidak terlaksana</td>
                <td>{{ $row->nomor_proposal }}</td>
                <td>@php 
                          foreach ($departemen as $dept) {
                          if($dept->id == $row->departemen ) {echo e($dept->nama_departemen);}
